...
Savant supports several source and sink adapters. The adapter protocol is an open protocol 
based on Avro and 0MQ. Everyone can develop her adapter and modify one of the currently developed. 
