...
class Overlay(NvDsDrawFunc):
    def __init__(self, **kwargs):
        ...
        self.encode_params = nvimgcodec.EncodeParams(quality_type=nvimgcodec.QualityType.QUALITY, quality_value=95)
    ...
    def draw(self, buffer: Gst.Buffer, frame_meta: NvDsFrameMeta):
        ...
        with nvds_to_gpu_mat(buffer, frame_meta.frame_meta) as frame_mat:
            ...
            self.codec.write(f'/screenshots/{frame_meta.source_id}-{uuid}.jpg', cupy_image, "jpeg", params=self.encode_params, cuda_stream=cuda_stream.cudaPtr())
