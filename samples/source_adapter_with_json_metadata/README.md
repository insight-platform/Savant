...
for the adapter is described in the documentation ([link](https://insight-platform.github.io/savant-ai.io/docs/latest/advanced_topics/9_input_json_metadata.html)). 
