...
build:
	...
	#docker tag savant-deepstream$(PLATFORM_SUFFIX) savant-deepstream$(PLATFORM_SUFFIX):$(SAVANT_VERSION)-$(DEEPSTREAM_VERSION)
...
build-adapters-deepstream:
	...
	#docker tag savant-adapters-deepstream$(PLATFORM_SUFFIX) savant-adapters-deepstream$(PLATFORM_SUFFIX):$(SAVANT_VERSION)-$(DEEPSTREAM_VERSION)
...
build-adapters-gstreamer:
	...
	#docker tag savant-adapters-gstreamer$(PLATFORM_SUFFIX) savant-adapters-gstreamer$(PLATFORM_SUFFIX):$(SAVANT_VERSION)
...
build-adapters-py:
	...
	#docker tag savant-adapters-py$(PLATFORM_SUFFIX) savant-adapters-py$(PLATFORM_SUFFIX):$(SAVANT_VERSION)
